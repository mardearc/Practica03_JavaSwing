...
public class PanInsertar extends JPanel {
    ...
    public PanInsertar(Lista<Cuenta> cuentas) {
    ...
    private void insertarCuenta() {
        try {
            ...
            if (rbtnCorriente.isSelected()) {
                ...
                cuentas.insertarNodo(new CuentaCorriente(numero, titular, saldoMinimo, saldo, fechaApertura, comision, tipoComision));
                ...
                cuentas.insertarNodo(new CuentaAhorro(numero, titular, saldoMinimo, saldo, fechaApertura, interesAnual, rentabilidad));
            }
            ...
            JOptionPane.showMessageDialog(this, "Error al insertar la cuenta: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
